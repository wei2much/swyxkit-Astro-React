...
export default function YouTubeEmbedWrapper({ videoId }: YouTubeEmbedWrapperProps) {
	...
	if (!isClient) {
		return (
			<div className="my-6">
				<div className="w-full bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg flex items-center justify-center" style={{ height: '400px' }}>
