---
title: About SwyxKit Astro + React
description: About SwyxKit - a complete port from SvelteKit to Astro + React with enhanced performance and modern tooling
---

# About SwyxKit Astro + React
...
- Original SwyxKit: [sw-yx](https://github.com/sw-yx)
- Design inspiration: [Lee Robinson](https://github.com/leerob/leerob.io/)
- Astro framework: [Astro team](https://astro.build)
- React library: [React team](https://react.dev)
- Tailwind CSS: [Tailwind team](https://tailwindcss.com)
